...
data_file = 'step_00_rect_map_paper_square_12mm_tif_2mm.mat';
...
hold on; plot3(dwell_x*1e3, dwell_y*1e3, 100*ones(size(dwell_x,2),1), 'b-', 'LineWidth', 1); hold off;
